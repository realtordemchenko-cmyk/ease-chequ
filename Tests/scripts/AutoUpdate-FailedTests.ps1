# AutoUpdate-FailedTests.ps1 — analyzes failed tests, shows diff, gives recommendation, asks Y/N,
# logs decisions (recursive search + User=Alexey + Group + Type=Production/Scaffold + Summary)
